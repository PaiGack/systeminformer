...
typedef enum _PH_TRAY_ICON_ID
{
    ...
    PH_TRAY_ICON_ID_UNION_HISTORY,
    PH_TRAY_ICON_ID_MAXIMUM
} PH_TRAY_ICON_ID;

// Bitmask flags for the tray union history icon metrics selection
// (stored in SETTING_ICON_TRAY_UNION_METRICS).
#define PH_TRAY_UNION_METRIC_CPU       0x1
#define PH_TRAY_UNION_METRIC_IO        0x2
#define PH_TRAY_UNION_METRIC_COMMIT    0x4
#define PH_TRAY_UNION_METRIC_PHYSICAL  0x8
#define PH_TRAY_UNION_METRIC_ALL       0xf
...
typedef enum _PH_TRAY_ICON_GUID
{
    ...
    PH_TRAY_ICON_GUID_UNION_HISTORY,
